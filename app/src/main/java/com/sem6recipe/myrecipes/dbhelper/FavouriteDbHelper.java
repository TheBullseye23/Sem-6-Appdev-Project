package com.sem6recipe.myrecipes.dbhelper;
...
public class FavouriteDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + TABLE + " (id TEXT PRIMARY KEY, name TEXT, direction TEXT, ingredients TEXT, image TEXT, category TEXT)";
        db.execSQL(query);
    }
    ...
    public List<Recipe> getAll() {
        ...
        while (cursor.moveToNext()) {
            ...
            Recipe recipe = new Recipe(id, name, direction, ingredients, image, category);
            recipes.add(recipe);
        }
